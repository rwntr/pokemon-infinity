...
WILD_BATTLE_TEST("Lucky Egg  & Training Band boost gained exp points by 50% and 500% respectively", s32 exp)
{
    u32 item = 0;
    ...
    GIVEN {
        ...
        PLAYER(SPECIES_TRUBBISH) { Level(100); Moves(MOVE_SPLASH); } //Procs training band
