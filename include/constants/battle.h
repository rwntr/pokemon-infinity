...
#define B_WEATHER_RAIN_PERMA        (1 << BATTLE_WEATHER_RAIN_PERMA)
#define B_WEATHER_RAIN_TEMPORARY    (1 << BATTLE_WEATHER_RAIN_TEMPORARY)
...
#define B_WEATHER_RAIN              (B_WEATHER_RAIN_TEMPORARY | B_WEATHER_RAIN_PRIMAL | B_WEATHER_RAIN_DOWNPOUR | B_WEATHER_RAIN_PERMA)
#define B_WEATHER_SUN_PERMA         (1 << BATTLE_WEATHER_SUN_PERMA)
#define B_WEATHER_SUN_TEMPORARY     (1 << BATTLE_WEATHER_SUN_TEMPORARY)
#define B_WEATHER_SUN_PRIMAL        (1 << BATTLE_WEATHER_SUN_PRIMAL)
#define B_WEATHER_SUN               (B_WEATHER_SUN_TEMPORARY | B_WEATHER_SUN_PRIMAL | B_WEATHER_SUN_PERMA)
