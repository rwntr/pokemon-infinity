...
const u8 gText_ThatItemIsSoldOut[] = _("You already have that TM!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Endure48BP[] = _("EndureE{CLEAR_TO 0x4E}48BP");
...
const u8 gText_SavingVersionNum[] = _("alpha 0.1");